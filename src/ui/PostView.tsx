...
// import { CanvasView } from './canvasView.js';
// import { getLastAction } from '../logic/notifications';

export function postView({ context }: { context: Devvit.Context }): JSX.Element {
  const { redis, ui, reddit, postId } = context;
  const [state, setState] = useState("home"); // canvas, leaderboard, help, home
  ...
  const handleNewChallenge = async () => {
    try {
      ...
      ui.showToast({
        text: `Created Challenge #${newChallengeId} as a new post!`,
        appearance: "success"
      });
    ...
    <zstack height="100%" width="100%" alignment='top start'>
      ...
      <vstack width="100%" height="100%" alignment="center middle">
        ...
        }
        {
          state === 'leaderboard' && (  
            <vstack height="100%" width="100%" alignment="center middle">
              <LeaderboardView context={context} onClose={onClose} />
            </vstack>
          )
        }
        {
